 ...
 */
export class SecurityError extends ResourceError {
  constructor(
    public readonly moduleId: string,
    public readonly reason: string
  ) {
    super(
      `Security violation for module "${moduleId}": ${reason}. ` +
        `This may indicate a path traversal attempt or malicious module configuration.`
    );
